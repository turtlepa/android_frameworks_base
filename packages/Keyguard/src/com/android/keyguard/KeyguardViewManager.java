...
public class KeyguardViewManager {
    ...
    private void customLockscreen() {
        ...
        path = path.replace("data/com.android.keyguard", "data/com.android.wallpapercropper");
    ...
    class ViewManagerHost extends FrameLayout {
        ...
        public void drawToCanvas(Canvas canvas, Drawable drawable) {
            if (drawable != null) {
                if (!mRotated && mBlurredImage != null && mKeyguardView != null) {
                    int rotation = mKeyguardView.getDisplay().getRotation();
                    int multiplicator = (rotation == 180) ? 180 : 90;
                    mBlurredImage = rotateBmp(mBlurredImage,
                                              mLastRotation - (rotation * multiplicator));
                    mLastRotation = rotation * multiplicator;
                    mRotated = true;
